            ...
            <div class="d-flex justify-content-center align-items-center container">
                <div class="row">
                    ...
                    <form action="./script.php" method="POST" class="form-control">
                        ...
                        <div class="form-group">
                            <div class="mb-4">
                                <input type="text" name="email" placeholder="Enter email" required value="<?php if (isset($_SESSION['userInfo']['email'])) echo $_SESSION['userInfo']['email']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="mb-4">
                                <input type="text" name="name" placeholder="Enter name" required value="<?php if (isset($_SESSION['userInfo']['name'])) echo $_SESSION['userInfo']['name']; ?>" class="form-control" id="exampleInputPassword1">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="mb-4">
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-center align-items-center container">
                                <p>Missclick? -
                                    <a href="/vendor/create.php">Refresh</a>
                                </p>
                            </div>
                        </div>
                    </form>
